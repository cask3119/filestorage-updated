...
async def SaveBatchMediaInChannel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=HindiMoviesv2_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Open Link", url=share_link)],
                 [InlineKeyboardButton("MOVIES CHANNEL", url="https://t.me/HINDIMOVIESV2"),
...
async def SaveMediaInChannel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=HindiMoviesv2_{str_to_b64(file_er_id)}"
        await editable.edit(
